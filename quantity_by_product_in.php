...
<head>
    ...
    <title>Quantity by product registered in store</title>
</head>
...
<body>
    <div class="container">
        ...
        <h4>Total quantity by product registered in the store:</h4>
        <?php
            ...
            if (!$db_connection) {
                ...
                while($row = mysqli_fetch_array($db_result)){
                    ...
                    $quantity_query = "SELECT quantity FROM stk_inventory WHERE productId=$productId";
