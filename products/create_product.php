...
<body>
    <div class="container">
        ...
        ?>
        <h4>Create/Insert a new Product:</h4>
        <form action="./finish_create_product.php" method="POST" autocomplete="off">
            ...
            <div class="input-item">
                ...
                <div class="input-sub-item">
                    <input type="tel" name="supplier-phone" id="sup-tel-number" />
                </div>
            </div>
            <div class="submission-btn-holder">
                <input type="submit" name="product-create-button" value="Create Product" />
            </div>
