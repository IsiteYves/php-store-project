...
?>
        <h4>Create/Insert a new Inventory:</h4>
        <form action="./finish_create_inventory.php" method="POST" autocomplete="off">
...
?>
            ...
            <div class="submission-btn-holder">
                <input type="submit" name="product-create-button" value="Create Inventory" />
            </div>
